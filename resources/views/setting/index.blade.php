    ...
    <div class="card shadow p-3">
        <form method="POST" action="{{ route('setting.update', $setting) }}" class="form" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    <label for="app_name" class="form-label required">App_Name</label>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('login_title') is-invalid @enderror"
                        ...
                        value="{{ old('login_title', $setting->login_title) }}"required>
                    @error('login_title')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control @error('keywords') is-invalid @enderror" id="keywords"
                        name="keywords" required value="{{ old('keywords', $setting->keywords) }}">
                    @error('keywords')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="file" class="form-control @error('logo') is-invalid @enderror" id="upload"
            ...
            <div class="text-end">
                <a class="btn btn-warning" href="{{ route('setting.create') }}" role="button">Cancel</a>
