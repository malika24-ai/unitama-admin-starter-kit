    ...
    <div class="card shadow p-3">
        <form method="POST" action="{{ route('user.store') }}" class="form" enctype="multipart/from-data">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    <label for="exampleInputEmail1" class="form-label required">Password</label>
                ...
                <div class="col-md-6">
                    <label for="exampleInputEmail1" class="form-label required">Konfirmasi Password</label>
                ...
                <div class="col-md-6">
                    ...
                    <img src="{{ asset('niceadmin/img/noprofil.png') }}" alt="avatar"
                        class="w-50 rounded
                    mt-2" id="preview">
            ...
            <div class="text-end">
                <a class="btn btn-warning" href="{{ route('user.create') }}" role="button">Cancel</a>
